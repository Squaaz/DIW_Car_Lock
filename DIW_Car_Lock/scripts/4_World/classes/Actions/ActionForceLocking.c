class ActionForceLockingVehicleCB : ActionContinuousBaseCB
{
...
class ActionForceLockingVehicle: ActionContinuousBase
{

  void ActionForceLockingVehicle()
	{
		m_CallbackClass = ActionForceLockingVehicleCB;
